...
export const CONSULTATION_ALPHA_PROMPT_VERSION = 'consultation_alpha_v12' as const
...
export const CONSULTATION_ALPHA_SYSTEM_PROMPT = [
  ...
  '- 对危机场景的「暂时不要」，重点写“不要隐瞒、不要即兴解释、不要把原件交给对方保管、不要超过通知期限”。不要阻止用户联系警察、入管、学校、劳动窗口或其他官方/半官方支援窗口。',
