...
const Q: Record<string, QuizQuestion> = {
  ...
  q10: {
    ...
    learnMore:
      '入管通过出入国記録核查实际在日时间。配偶者签证下，长期不在日本会让入管怀疑「夫妻同居」是否实质存在。出入国記録可在最近的入国管理局窗口当场打印。[待书士审核]',
    options: [
      ...
      },
      {
        ...
        selfFix: false,
        fixHint:
          '入管会重点审查婚姻实质性。建议书士介入，准备：出境理由详细说明、配偶在海外的状况、夫妻交流记录、未来在日同居计划等组合材料。',
      },
    ],
  },
  q11: {
    ...
    learnMore:
      '課税証明書由住所所在地市役所「税務課」发行。中途搬家、未做転入届、当年没有收入也会让某些年份开不出。可以提前去市役所窗口确认能开出哪几年。[待书士审核]',
    options: [
      ...
      },
      {
        ...
        selfFix: false,
        fixHint:
          '说明你过去若干年与日本税务系统断链。请书士介入，评估如何用配偶収入証明 / 储蓄証明 / 補正申告等组合材料补正。',
      },
      { label: '不确定', next: 'q12' },
    ],
  },
  ...
  q13: {
    ...
    learnMore:
      '配偶者签证不强制申请人工作；申请人无収入由配偶承担生活费完全合规。但如果你有自己的工作，雇用契約形態（正社員 / 派遣 / 業務委託 / 試用期）会影响入管对「在日生活基盘」的判定，间接影响在留期间长度。[待书士审核]',
    options: [
