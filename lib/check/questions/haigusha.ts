...
const Q: Record<string, QuizQuestion> = {
  q1: {
    ...
    learnMore:
      '已离婚或正在离婚的情况下，配偶者签证的在留资格基础可能发生变化。请尽快确认变更路径；涉及期限或个案事实时，建议带材料向行政书士等专业人士确认。',
    options: [
      { label: '是，婚姻正常', next: 'q2' },
      {
        ...
        selfFix: false,
        fixHint:
          '请尽快确认变更为其他在留资格（定住者等）的路径；涉及期限或个案事实时，建议带材料向行政书士等专业人士确认。',
      },
    ],
  },
  q2: {
  ...
  q4: {
    ...
    why: '税款记录是续签审查的基础项目',
    learnMore:
      '住民税欠缴可能成为不利因素。申请前应确认缴纳状态，补缴后保留相关证明。',
    options: [
  ...
  q6: {
    ...
    why: '违规记录可能影响续签审查',
    learnMore:
      '有违规记录不必然导致不许可，但需要结合具体情况说明。未说明或说明不一致可能产生不利影响。',
    options: [
      { label: '没有', next: 'q7' },
      {
        label: '有',
  ...
  q10: {
    ...
    options: [
      ...
      },
      {
        ...
        selfFix: false,
        fixHint:
          '入管可能会重点确认婚姻实质。建议准备出境理由、配偶在海外情况、夫妻交流记录和未来同居计划，并向行政书士等专业人士确认说明方式。',
      },
    ],
  },
  q11: {
    ...
    options: [
      { label: '能完整拿到 3 年', next: 'q12' },
      {
        ...
        selfFix: false,
        fixHint:
          '附一份无法取得该年度证明的说明，写清原因，并由配偶提供该年度的課税証明書。',
      },
      {
        label: '多个年份开不出',
        next: 'q12',
