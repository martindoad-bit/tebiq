...
const Q: Record<string, QuizQuestion> = {
  q1: {
    ...
    learnMore:
      '転入届超期可能影响住民票记录，进而影响续签材料的完整性。发现超期后，尽快到新住所所在地市役所确认补办方式。',
    options: [
      { label: '已完成', next: 'q2' },
      {
        label: '还没有 / 超期了',
        ...
        selfFix: true,
        fixHint: '尽快到新住所所在地市役所确认补办方式，并保留办理记录。',
      },
    ],
  },
  q2: {
    ...
    why: '在留卡地址需要及时更新',
    learnMore:
      '在留卡通常需要在転入届时同步更新地址（在市役所窗口即可）。地址不一致可能影响后续手续；尚未更新时，请尽快到市役所确认办理方式。',
    options: [
      { label: '已更新', next: 'q3' },
      {
        label: '还没有',
