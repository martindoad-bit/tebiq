...
export const QUESTIONS: Record<string, Question> = {
  ...
  '7': {
    ...
    options: [
      { label: '到期前递交', next: '8' },
      {
        ...
        selfFix: false,
        fixHint:
          '在留期限届满后才提交属于不法残留，哪怕只超 1 天也会留记录。这种情况风险很高，请不要自行递签。请尽快和专家面谈，评估特定活动签证或重新出入境的可行性，每多拖一天处理空间都会变小。',
      },
  ...
  '10': {
    ...
    why: '雇主状况影响续签审查',
    learnMore:
      '如果你不确定公司的经营状况，可以观察：工资是否按时发放、是否有大规模裁员、客户业务是否正常。不确定的话可以先问同事或 HR。\n\n⚠️ 2026 年 4 月 15 日新规（已生效）：如果你的雇主属于类别 3 或 4（非上市中小企业），且工作以日语对人业务为主（翻译、营业、前台接待等），续签时需额外提交：①所属机构代表者申报书 ②JLPT N2 以上等语言能力证明。IT 工程师等技术岗位是否需要目前尚不明确，建议提前向公司人事确认。',
    options: [
      { label: '正常运营', next: '12' },
      { label: '不正常', next: '11' },
      {
  ...
  '13': {
    ...
    options: [
      ...
      },
      {
        ...
        selfFix: false,
        fixHint:
          '护照已过期或即将过期是高风险情况。请立即联系中国驻日大使馆/总领馆紧急办理护照换发，并向专家咨询是否需要提前递交「再入国不要」声明等补救材料。',
      },
    ],
  },
  ...
  '15': {
    ...
    options: [
      ...
      },
      {
        ...
        selfFix: false,
        fixHint:
          '高风险。入管可能直接认定不再符合「在日活动」要件。请尽快和专家面谈，评估是否需要先取得「再入国許可」延长 / 切换签证 / 接受短期在留期间。',
      },
    ],
  },
  '16': {
  ...
  '18': {
    ...
    options: [
      ...
      },
      {
        ...
        selfFix: false,
        fixHint:
          '業務委託在技人国下风险高，可能被认定为「実际は経営者」需走経営・管理。请尽快和专家面谈评估是否切换签证类别。',
      },
      {
        label: '目前無職 / 离职中',
        next: null,
