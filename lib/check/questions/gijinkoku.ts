...
export const QUESTIONS: Record<string, Question> = {
  ...
  '14': {
    ...
    learnMore:
      '常被忽视的范围：軽犯罪法処分、商店扒窃、迷惑防止条例違反、行政罚金（垃圾分类罚金不算）、不法滞在记录、入管警告、ハローワーク给付资格停止处分等。即使最终不起诉、罚金缴清，也会留在数据库中。如不确定可申请「犯罪歴証明書」查询。[待书士审核]',
    options: [
      { label: '完全没有', next: '15' },
      {
        label: '有过罚金或軽犯罪法処分',
        ...
        selfFix: false,
        fixHint:
          '罚金 / 軽犯罪法処分本身不致命，但隐瞒被查到后果严重。在申请书附 1 份说明书：何时何地何事 / 缴清证明 / 已无再犯。建议由书士过一遍措辞。',
      },
      {
        ...
        selfFix: false,
        fixHint:
          '入管视角下这是高风险信号。不要自行递签。请尽快和书士面谈，评估是否需要先取得「在留特別許可」或更换签证类别。',
      },
      { label: '不确定', next: '15' },
    ],
  },
  '15': {
    ...
    learnMore:
      '入管通过出入国記録（出入国記録）核查实际在日时间。技人国期间长期在海外（如远程办公）会影响续签和未来永住申请的「在日継続性」要件。出入国記録可在最近的入国管理局窗口当场打印。[待书士审核]',
    options: [
      ...
      },
      {
        ...
        selfFix: false,
        fixHint:
          '入管会质疑「为什么持有日本签证却长期不在日」。准备：海外原因详细说明（出差/家人/学习等）、雇主出具的「海外赴任理由书」、海外期间的薪资仍由日本公司支付的证明。建议书士介入。',
      },
      {
        label: '超过 1 年',
        next: '16',
        ...
        selfFix: false,
        fixHint:
          '高风险。入管可能直接认定不再符合「在日活动」要件。请尽快和书士面谈，评估是否需要先取得「再入国許可」延长 / 切换签证 / 接受短期在留期间。',
      },
    ],
  },
  '16': {
    ...
    learnMore:
      '課税証明書由住所所在地市役所「税務課」发行（或对应区役所），通常需要本人在该年 1 月 1 日已在该市登録住民票才能开。中途搬家、未做転入届、当年没有收入也会让某些年份开不出。可以提前去市役所窗口确认能开出哪几年。[待书士审核]',
    options: [
      { label: '能完整拿到 3 年', next: '17' },
      {
        ...
        selfFix: false,
        fixHint:
          '附 1 份「不開可説明書」解释原因（如当年在海外、搬家空窗、未就职等），并提供能证明收入或活动的替代材料（源泉徴収票 / 海外公司在职证明等）。建议书士帮你设计组合材料。',
      },
      {
        label: '多个年份开不出',
        next: '17',
        ...
        selfFix: false,
        fixHint:
          '说明你过去若干年与日本税务系统断链，入管会重点审查。请尽快和书士面谈，评估如何重建税务证明（含補正申告等）。',
      },
      { label: '不确定', next: '17' },
    ],
  },
  '17': {
    ...
    learnMore:
      '正常情况：搬家做転入届、海外长期出差不办「海外転出届」就保留登録。脱漏发生在：办了海外転出届但回来后没及时転入、搬家后忘办転入届超 14 天等。住民票履歴可以在市役所开「住民票（除票含む）」查阅。[待书士审核]',
    options: [
      { label: '没有脱漏', next: '18' },
      {
      ...
      },
      {
        ...
        selfFix: false,
        fixHint:
          '住民票断档对应「不在日本」或「未办手续」状态，入管会与出入国記録交叉对比。请书士介入处理。',
      },
      { label: '不确定', next: '18' },
    ],
  },
  '18': {
    ...
    learnMore:
      '入管对「就業稳定性」的判断主要看契約形態。无期限正社員 → 高分；有期限契約社員 → 中等；業務委託 / フリーランス → 容易被质疑「实际是事業主」需走経営・管理签；派遣社員 → 受 2026 年 3 月 9 日新规严格审查。試用期内续签可能拿到较短在留期间。[待书士审核]',
    options: [
      ...
      },
      {
        ...
        selfFix: false,
        fixHint:
          '2026 年 3 月 9 日新规对派遣形态大幅严格化。需准备：派遣元 / 派遣先双方誓约书、派遣先業務内容説明資料、最近 6 个月工资证明。强烈建议书士介入。',
      },
      {
        label: '業務委託 / フリーランス',
        next: null,
        ...
        selfFix: false,
        fixHint:
          '業務委託在技人国下风险高，可能被认定为「実际は経営者」需走経営・管理。请尽快和书士面谈评估是否切换签证类别。',
      },
      {
        label: '目前無職 / 离职中',
        next: null,
