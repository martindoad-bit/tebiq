...
export const QUICK_REFERENCE_TOPICS: QuickReferenceTopic[] = [
  ...
  },
  {
    ...
    title: '家族滞在 变更材料',
    summary: '已经在日本的人想改成家族滞在时，先确认扶养者资格、关系证明、生活费和当前在留期限。',
    category: '更新变更',
    factCardIds: [
      'kazoku-taizai-henko',
      'kazoku-taizai-yoken',
    ...
    aliases: ['家族滞在变更', '家属签变更', '配偶改家族滞在', '留学转家族滞在', '工作签转家族滞在'],
    deadline: '需要在当前在留期限前申请；不要等到期限后才准备。',
    whereToGo: '地方出入国在留管理局办理在留资格变更许可申请。',
    prepare: [
      '在留资格变更许可申请书 + 写真',
      '护照 + 在留卡',
      '与扶养者的关系证明 + 日文翻译',
      '扶养者的在留卡、在职/在学资料',
      '扶养者的课税·纳税证明、存款或奖学金资料',
      '现在在留资格和离职/退学/婚姻等变更理由资料',
    ],
    askPrompt: '我人在日本，想改成家族滞在，想确认是不是走变更申请、材料怎么准备。',
    facts: [
      {
        label: '国内变更',
        text: '已经在日本的人通常看在留资格变更；海外家属来日本通常看 COE 呼寄せ。',
        verification: 'source-backed',
      },
      {
        label: '扶养关系',
        text: '材料重点是扶养者资格、关系证明和生活费负担能力；是否能许可仍按个案审查。',
        verification: 'needs-check',
      },
    ],
    checkNote: '非法打工记录、离职/退学后空白期、扶养者收入下降、配偶分居等情况，不能只按材料清单处理。',
    sources: [
      {
        label: '出入国在留管理庁：「家族滞在」',
  ...
  {
    id: 'eijuu-haigusha-materials',
    title: '永住者配偶者等 更新・变更材料',
    summary: '永住者或特别永住者的配偶/子女路线，先分清 sponsor、关系证明、费用证明和保证人资料。',
    category: '更新变更',
    factCardIds: [
      'eijuu-haigusha-visa',
      'zairyu-expiry-renewal-change',
    ...
    deadline: '更新通常可在在留期间满了的大约 3 个月前开始；变更要在当前在留期限前确认。',
    whereToGo: '住所地管辖的地方出入国在留管理局；市区町村取住民票和税证明。',
    prepare: [
      '在留资格变更/期间更新申请书 + 写真',
      '护照 + 在留卡',
      '婚姻关系或亲子关系证明 + 日文翻译',
      '永住者/特别永住者一方的住民票或身份资料',
      '滞在费用证明（课税·纳税证明、存款资料等）',
      '身元保证书',
    ],
    askPrompt: '我准备办永住者の配偶者等的更新或变更，想确认材料和日本人配偶者路线有什么不同。',
    facts: [
      {
        label: '路线不同',
        text: '这里是永住者或特别永住者的配偶/子女路线，不是日本人配偶者路线，也不是永住申请本身。',
        verification: 'source-backed',
      },
      {
        label: '材料边界',
        text: '清单只整理材料脉络；婚姻实态、同居、收入稳定性和变更相当理由仍需个案确认。',
        verification: 'needs-check',
      },
    ],
    ...
    sources: [
      ...
      {
        label: '出入国在留管理庁：「永住者の配偶者等」変更提出書類',
        url: 'https://www.moj.go.jp/isa/content/001426554.pdf',
      },
      {
        label: '出入国在留管理庁：「永住者の配偶者等」更新提出書類',
        url: 'https://www.moj.go.jp/isa/content/001426555.pdf',
      },
    ],
  },
  {
  ...
  {
    id: 'family-stay-coe-materials',
    title: '家族滞在 呼寄せ COE 材料',
    summary: '海外配偶者或子女想以家族滞在来日本时，先确认扶养者资格、收入和关系证明。',
    category: '更新变更',
    factCardIds: [
      'kazoku-yobi-yose',
    ...
    aliases: ['家族滞在呼寄せ', '家族COE', '配偶者COE', '孩子COE', '海外家属', '扶养家属'],
    deadline: 'COE 没有固定申请窗口；要倒推入国予定日、审查时间和扶养者入社/收入资料准备时间。',
    whereToGo: '地方出入国在留管理局申请在留资格认定证明书（COE）。',
    prepare: [
      '在留资格认定证明书交付申请书 + 写真',
      '配偶/子女关系证明 + 日文翻译',
      '扶养者的在留卡或护照资料',
      '扶养者的在职/在学/事业证明',
      '扶养者的收入、存款、奖学金或生活费负担资料',
      '入社前或内定阶段的补充说明资料（如适用）',
    ],
    askPrompt: '我还没正式入社/刚拿到内定，想确认能不能同时给配偶或孩子办家族滞在 COE。',
    facts: [
      {
        label: '对象',
        text: '家族滞在主要面向一定在留资格者扶养的配偶或子女；父母、兄弟姐妹通常不是这一路线。',
        verification: 'source-backed',
      },
      {
        label: '内定阶段',
        text: '内定或入社前的同時申请、代替资料和扶养能力证明属于个案确认；不要只凭内定通知书判断。',
        verification: 'needs-check',
      },
    ],
    checkNote: '海外呼寄せ是 COE 路线；已经在日本的人改成家族滞在通常是变更路线，别混用。',
    sources: [
      {
        label: '出入国在留管理庁：「家族滞在」',
        url: 'https://www.moj.go.jp/isa/applications/status/dependent.html',
