...
## Login UI 最后修复
- 修复登录方式 tab 选中态: 深色背景使用白色文字，邮箱/手机号选中态均可读。
- 修复邮箱输入框层级: icon 固定左侧，input 使用 `pl-11`，placeholder / 输入文字不重叠。
- 修复登录页宽屏约束: 主体内容限制 `max-w-[420px]` 并居中，移动端防横向溢出。
- 本地 5 档视口检查: 320 / 375 / 393 / 430 / 768 均无横向滚动；320 下邮箱和手机号 tab 均可见。
