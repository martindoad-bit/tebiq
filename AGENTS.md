...
| 5 | `docs/product/TEBIQ_CONTEXT_PACK.md` | 所有窗口（长期产品宪法）|
| 6 | `docs/product/TEBIQ_QA_GATES.md` | QA / PR 审计 |
| 7 | `docs/product/TEBIQ_COPY_SOURCE.md` | 文案 / 用户端表达任务 |
| 8 | `docs/ops/TEBIQ_AGENT_WORKFLOW.md` | 不确定协作流程时 |
...
最新协作边界以 `docs/ops/TEBIQ_ROLES_V2.md` 为准；短期状态以
`docs/product/TEBIQ_CURRENT_STATE.md` 为准。下表保留角色边界；
如 "当前 Track" 与 Current State 冲突，以 Current State 为准。
