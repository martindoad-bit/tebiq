...
1. 「特定技能1号で妻（夫）を呼べますか」→ 特定技能1号は家族滞在対象外の説明
2. 「家族滞在签证怎么申请」→ 扶養者の在留資格確認 + 申請書類説明
3. 「留学生の家族は家族滞在ビザを取れますか」→ 留学は対象主ビザのため可能と説明
4. 「家族滞在ビザでアルバイトはできますか」→ 資格外活動許可が必要（週28時間）と説明
5. 「技人国で家族を連れてきたい」→ 技人国は対象主ビザのため可能と説明
6. 「配偶者を日本に連れてくるにはどんなビザが必要ですか」→ 家族滞在ビザの概要説明
7. 「家族滞在怎么转成工作签证」→ 家族滞在→就労ビザへの変更条件説明
8. 「家族滞在的家人能打工吗」→ 資格外活動許可の必要性・週28時間制限説明
