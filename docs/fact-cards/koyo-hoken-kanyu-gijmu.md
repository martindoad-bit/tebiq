...
citation_label: "雇用保険加入義務（週20時間以上・外国人労働者・外国人雇用届出期限・失業給付）"
citation_summary: "週20時間以上勤務する外国人労働者の雇用保険加入義務と、事業主の外国人雇用届出（ハローワーク）義務を確認するカード。外国人雇用届出の期限は雇用保険被保険者か否かで異なる。失業給付の受給要件の概要も含む。"
...
direct_fact_fields:
  ...
  - 外国人雇用届出義務：事業主は外国人労働者を雇用・離職させた場合、ハローワークへの届出が必要（労働施策総合推進法）。届出期限は雇用保険被保険者か否かで異なり、被保険者は雇入れ翌月10日まで・離職翌日から10日以内、非被保険者は雇入れ/離職とも翌月末日まで
...
evidence_points:
  - claim: "雇用保険：31日以上雇用される見込みがあり、1週間の所定労働時間が20時間以上である労働者は雇用保険の適用対象。"
    source_title: "厚生労働省：雇用保険の加入手続はきちんとなされていますか！"
    source_url: "https://www.mhlw.go.jp/stf/seisakunitsuite/bunya/0000147331.html"
    source_organization: "厚生労働省"
    source_locator: "ページ内「31日以上雇用されることが見込まれる」「1週間の所定労働時間が20時間以上」の記述を確認"
    display_label: "雇用保険：31日以上見込み・週20時間以上が適用要件"
    support_level: "direct"
    user_visible: true
    needs_domain_review: false
  - claim: "外国人雇用状況の届出義務（労働施策総合推進法）：事業主は外国人労働者の雇用・離職の都度、ハローワークへ届出。期限は雇用保険被保険者か否かで異なる。未届け・虚偽届出には30万円以下の罰金。"
    ...
    source_organization: "厚生労働省"
    source_locator: "ページ内「外国人雇用状況の届出」「労働施策総合推進法」「罰則（30万円以下の罰金）」の記述を確認"
    display_label: "外国人雇用届出：期限は区分別・未届けは30万円以下の罰金"
    support_level: "direct"
    user_visible: true
    needs_domain_review: false
  - claim: "失業給付（基本手当）の受給要件：雇用保険の被保険者であった期間が離職前2年間に通算12か月以上（特定受給資格者・特定理由離職者は6か月以上）。"
    source_title: "ハローワーク：基本手当について"
    source_url: "https://www.hellowork.mhlw.go.jp/insurance/insurance_basicbenefit.html"
    source_organization: "ハローワーク"
    source_locator: "ページ内「離職の日以前2年間に、被保険者期間が通算して12か月以上」「特定受給資格者又は特定理由離職者...6か月以上」の記述を確認"
...
本カードの内容は {{TODAY_ISO}} 時点での雇用保険法・労働施策総合推進法（旧雇用対策法）に基づく。
...
**事業主の届出義務（外国人雇用状況の届出）：**
- 外国人を雇用したとき → 雇用保険被保険者は翌月10日まで、非被保険者は翌月末日までにハローワークへ届出
- 外国人が離職したとき → 雇用保険被保険者は離職翌日から10日以内、非被保険者は翌月末日までにハローワークへ届出
...
- 事業主には外国人雇用の届出義務あり（ハローワーク。期限は雇用保険被保険者か否かで異なる）
...
・事業主義務：外国人雇用・離職時にハローワークへ届出。期限は雇用保険被保険者か否かで異なる（被保険者：雇入れ翌月10日まで / 離職翌日から10日以内、非被保険者：雇入れ・離職とも翌月末日まで）
