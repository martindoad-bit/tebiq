...
citation_summary: >-
  帰化許可申請の6要件：(1)継続5年以上日本居住、(2)18歳以上で本国法でも成人、(3)素行善良、(4)生計安定、(5)原国籍喪失（または無国籍）、(6)憲法遵守。
...
applies_to:
  - 帰化希望者
direct_fact_fields:
  - 帰化には住所・能力・素行・生計・重国籍防止・憲法遵守の一般要件がある
  - 申請先は住所地を管轄する法務局・地方法務局
ai_inferred_fields:
...
evidence_points:
  - claim: 帰化には住所・能力・素行・生計・重国籍防止・憲法遵守の一般要件があり、申請先は住所地管轄の法務局・地方法務局。
