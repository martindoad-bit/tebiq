...
needs_review_flags:
  ...
  - activity_scope_no_work_restriction: 日本人の配偶者等の就労制限なし・活動範囲については法令または公式資料の直接根拠確認要。
related_links:
...
「日本人の配偶者等」は日本人との実態ある婚姻関係に基づく身分系在留資格。在留期間は5年・3年・1年・6か月で、更新時は婚姻実態が確認される可能性がある。

**主要事実（{{TODAY_ISO}} 現在）：**
- 対象：日本人の配偶者、日本人の子（実子）、日本人の特別養子
- 在留期間：5年・3年・1年・6か月（審査結果によって決定）
- 就労範囲・活動制限の扱いは法令または公式資料で確認要（`activity_scope_no_work_restriction`）
