...
expected_direction: |
  ...
  先确认通知书期限、是否要审查请求/再申请、是否还计划回日本；不要把期限内自主离境一律说成5年上陆拒否
must_have:
  - 不许可后3个月内可提审查請求（行政不服申立法）
  - 出国决策必须分情况：期限内自主离境、审查请求/再申请计划、退去强制/不法滞在风险不能混为一谈
  - 不许可通知上的理由要旨是再申请的关键依据（要保存）
  - 如果想争取留下、申诉、再申请或以后再来日本，立即联系行政書士/入管専門弁護士
must_not_have:
  - "出国重新申请更容易"（跳过通知书期限、审查请求和再申请策略判断）
  - "完了没希望了"（放弃合法救济）
  - 不提专业handoff
  - "3个月以后再考虑"（可能超过审查请求期限）
...
eval_method: |
  Pass（通过）：
  - 提及 3个月 / 3ヶ月 / 審査請求
  - 提及出国前要先确认通知书期限和后续意图；不得一律恐吓5年拒否
  - 明确建议行政書士/弁護士介入
  Fail（P0失败）：
