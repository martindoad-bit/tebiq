  ...
  return (
    <AppShell appBar={<AppBar title="找书士" />} tabBar={<TabBar />}>
      <div className="space-y-4 pt-3">
        <section className="rounded-card border border-hairline bg-surface px-4 py-4">
          <div className="flex items-start gap-3">
            ...
            <div className="min-w-0">
              <p className="text-[11px] font-medium uppercase tracking-normal text-haze">
                行政书士咨询
              </p>
              <h1 className="mt-1 text-[22px] font-medium leading-tight text-ink">
                找行政书士确认
              </h1>
              <p className="mt-2 text-[12.5px] leading-[1.7] text-slate">
        ...
        <section className="rounded-card border border-hairline bg-surface px-4 py-4">
          <p className="text-[12px] font-medium text-ash">费用</p>
        ...
        <section className="rounded-card border border-hairline bg-surface px-4 py-4">
          ...
          <ul className="mt-3 space-y-2.5 text-[12.5px] leading-[1.7] text-slate">
        ...
        <section className="rounded-card border border-hairline bg-paper px-4 py-4">
          <div className="flex items-start gap-2">
            ...
            <p className="text-[12px] leading-[1.7] text-slate">
        ...
        <Link
          href="/consultation"
          className="focus-ring flex min-h-[48px] w-full items-center justify-center gap-2 rounded-btn bg-ink px-4 py-3 text-[14px] font-medium leading-none text-white"
        >
          查看预约方式
