  ...
  questions: [
    {
      ...
      options: [
        { text: '已完成', value: 'yes' },
        { text: '还没有 / 超期了', value: 'no' },
      ],
      yellowIf: 'no',
      learnMore:
        '転入届超期通常不会有直接罚款，但会影响住民票记录，进而影响续签材料的完整性。发现超期立刻去办，窗口工作人员会处理。[待书士审核]',
    },
    {
      id: 'q2',
      text: '在留卡背面的地址是否已经更新？',
      ...
      redIf: 'no',
      learnMore:
        '在留卡必须在転入届时同步更新地址（在市役所窗口即可）。地址不一致在路检时可能被质疑，且影响续签申请。立刻去市役所办理。[待书士审核]',
    },
    {
      id: 'q3',
      text: '搬家的同时是否换了工作？',
      ...
      options: [
        { text: '没有换工作', value: 'no' },
        { text: '同时换了工作', value: 'yes' },
      ],
      learnMore:
        '换工作需要在 14 天内单独向入管局提交変更申報，和搬家手续是两件独立的事情，不要遗漏。[待书士审核]',
    },
    {
      id: 'q3a',
      showIf: { q3: 'yes' },
      ...
      redIf: 'no',
      learnMore:
        '可通过入管局电子届出系统在线申报，无需亲自前往。越早越好，影响续签记录。[待书士审核]',
    },
    {
      id: 'q4',
      ...
      yellowIf: 'no',
      learnMore:
        '公司 HR 需要更新住民税の特别徴収の届出地址，否则住民税通知可能寄到旧地址导致欠缴。[待书士审核]',
    },
    {
      id: 'q5',
      text: '银行和手机账户地址是否已更新？',
      ...
      yellowIf: 'no',
      learnMore:
        '银行地址不更新可能导致重要文件（在留卡更新通知、税务文件等）无法收到。各银行网银通常可以在线更新。[待书士审核]',
    },
  ],
  materials: [
    '転出届（旧市役所提交）',
